(function (window, document, $, undefined) {
	...
	$.extend(F, {
		// The current version of imagebox
		version: '1.0',
		...
		defaults: {
			...
			tpl: {
				...
				next     : '<a title="Next" class="imagebox-nav imagebox-next" href="javascript:;"><span></span></a>',
				prev     : '<a title="Previous" class="imagebox-nav imagebox-prev" href="javascript:;"><span></span></a>'
			},
		...
		close: function (event) {
			...
			if (!F.isOpen || event === true) {
				...
				F.wrap.stop(true, true).removeClass('imagebox-opened');
		...
		// Manage slideshow:
		//   $.imagebox.play(); - toggle slideshow
		//   $.imagebox.play( true ); - start
		//   $.imagebox.play( false ); - stop
		...
		update: function (e) {
			...
			didUpdate = setTimeout(function() {
				...
				F.wrap.removeClass('imagebox-tmp');
		...
		toggle: function ( action ) {
			if (F.isOpen) {
				...
				if (isTouch) {
					F.wrap.removeAttr('style').addClass('imagebox-tmp');
		...
		showLoading: function () {
			...
			el = $('<div id="imagebox-loading"><div></div></div>').click(F.cancel).appendTo('body');
		...
		_afterZoomIn: function () {
			...
			F.wrap.css('overflow', 'visible').addClass('imagebox-opened');
	...
	F.helpers.overlay = {
		...
		create : function(opts) {
			...
			this.overlay = $('<div class="imagebox-overlay"></div>').appendTo( 'body' );
			this.fixed   = false;
